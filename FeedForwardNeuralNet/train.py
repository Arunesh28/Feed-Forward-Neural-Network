...
def parse():
    ...
    parser.add_argument('--wandb_project','-wp', type=str, default="CS6910_Assignment_1")
    parser.add_argument('--wandb_entity','-we', type=str, default='Arunesh J B')
    parser.add_argument('--dataset','-d',type=str,default = 'fashion_mnist')
    parser.add_argument('--epochs','-e', type=int, default=2)
    parser.add_argument('--batch_size','-b', type=int, default=512)
    parser.add_argument('--loss','-l', type=str, default='cross_entropy')
    parser.add_argument('--optimizer','-o', type=str,default='rmsprop')
    parser.add_argument('--learning_rate','-lr',type = float, default = 0.001)
    parser.add_argument('--momentum','-m', type=float, default=0.9)
    parser.add_argument('--beta','-beta', type=float, default=0.9)
    parser.add_argument('--beta1','-beta1', type=float, default=0.9)
    parser.add_argument('--beta2','-beta2', type=float, default=0.999)
    parser.add_argument('--epsilon','-eps', type=float, default=0.00000001)
    parser.add_argument('--weight_decay','-w_d', type=float, default=0.0005)
    parser.add_argument('--weight_init','-w_i', type=str, default='xavier')
    parser.add_argument('--num_layers','-nhl', type=int, default=10)
